...
![Screenshot: Mockup visuale Paper-Stream concept di Gemini - timeline verticale con nodi lime](https://github.com/log-puck/log-puck-blog/blob/main/assets/images/Mockup-visuale-Paper-Stream.png)
...
**4. Data Format?**
→ **Solo JSON** (non duplicato YAML)
→ Dual purpose: Jekyll Liquid + JavaScript filtri
→ Principio KISS
...
Architettura modulare è CDC che è diventato pattern replicabile.
